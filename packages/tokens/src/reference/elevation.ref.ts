export const elevation = {
    surface : {
        default : {
            '400' : { value: [  "pwdr.sys.elevation.shadow-size.24",  'pwdr.ref.color.shadow.default' ] },
            '300' : { value: [  "pwdr.sys.elevation.shadow-size.16",  'pwdr.ref.color.shadow.default' ] },
            '200' : { value: [  "pwdr.sys.elevation.shadow-size.8",   'pwdr.ref.color.shadow.default' ] },
            '100' : { value: [  "pwdr.sys.elevation.shadow-size.4",   'pwdr.ref.color.shadow.default' ] },
        },
